...
from config.couchbase import get_couchbase_lifespan
from config.keycloak import keycloak_config, map_user
from config.minio import get_minio_lifespan
from models.consumer import kafka_consumer
from models.producer import kafka_producer
...
async def app_lifespan(app: FastAPI):
    ...
    async with AsyncExitStack() as stack:
        ...
        await stack.enter_async_context(get_minio_lifespan(app))
...
# Routers
app.include_router(prompt_router, prefix=settings.API_V1_PREFIX)
